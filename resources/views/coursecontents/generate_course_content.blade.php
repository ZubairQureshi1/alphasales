                                    ...
                                    <table class="table table-hover table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td id="content_program_name"></td>
                                            </tr>
                                            <tr>
                                                <td><strong>Subject Name</strong></td>
                                                <td id="content_subject_name"></td>
                                            </tr>
                                            <tr>                                            
                                                <td><strong>Credit Hours</strong></td>
                                                <td id="content_subject_credit"></td>
                                            </tr>    
                                            <tr>
                                            ...
                                            <tr>    
                                                <td><strong>Prerequisities</strong></td>
                                                <td id="content_subject_prerequisit"></td>
                                            </tr>
                                            <tr>    
                                                <td><strong>Faculty Name</strong></td>
                                                <td id="content_subject_teacher"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
<script src="{{ asset('js/studyscheme/generate_course_content.js') }}"></script>
