                ...
                <div class="m-b-10">
                    <div class="m-t-10 div-border-rad">
                        <div class="margin-10">
                            <div class="row">
                            <div class="col-sm-3">
                                <a href="{{route('courseContent.create')}}" class="btn btn-primary">Create New Course Content</a>
                            </div>
                            <div class="col-sm-3">
                                <a href="{{route('editCourseContent')}}" class="btn btn-primary">Update Course Content</a>
                            </div>
                            <div class="col-sm-3">
                                <a href="{{route('generateCourseContent')}}" class="btn btn-primary">Generate Course Content</a>
                            </div>
                            <div class="col-sm-3">
                                <a href="{{route('courseContentRecord')}}" class="btn btn-primary">Course Content Record</a>
                            </div>
                            </div>
                        </div>
                    </div>
