...
@include('includes/header_end')
        ...
        <ul class="list-inline menu-left mb-0">
            ...
            <li class="hide-phone list-inline-item app-search">
                <h3 class="page-title">Edit Installment Plans</h3>
            </li>
        </ul>
            ...
            <div class="col-12">
                <div class="card m-b-30" >
                    <div class="card-body">
                      ...
                      <form class="" method="POST" action="{{ route('installmentplans.update',$installmentplan['id']) }}">
                            {{method_field('PATCH')}}
                            @csrf
                            <div class="form-group">
                                ...
                                <select class="form-control" name="academic_term_id" id="academic_term_id">
                                	...
                                	<option {{$installmentplan['academic_term_id'] == $key ? 'selected' : ''}} value="{{$key}}">{{$academic_term}}</option>
                                	@endforeach 
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="number"
                                           ...
                                           name="max_installments" value="{{$installmentplan['max_installments']}}" 
                                ...
                                <div>
                                    <input type="number"
                                           class="form-control text-right" required
                                           name="min_installments" value="{{$installmentplan['min_installments']}}"
                                ...
                                <div>
                                    <input type="number"
                                           class="form-control text-right" required
                                           name="max_discount" value="{{$installmentplan['max_discount']}}"
                                ...
                                <div>
                                    <input type="number"
                                           class="form-control text-right" required
                                           name="min_discount" value="{{$installmentplan['min_discount']}}"
