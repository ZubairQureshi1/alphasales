<div class="vd_content-section clearfix">
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li class=""> <a data-toggle="tab" href="#photos-tab"> Photos <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li class=""> <a data-toggle="tab" href="#friends-tab"> Friends <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li class=""> <a data-toggle="tab" href="#groups-tab"> Groups <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
  </ul>
      ...
      <div class="pd-20">
        ...
        <br>
                <div class="isotope js-isotope vd_gallery" style="position: relative; height: 3000px;">
                  ...
                  <div class="gallery-item  filter-2" style="position: absolute; left: 200px; top: 0px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-200px, 200px, 0px);">                  	
                  ...
                  <div class="gallery-item  filter-2" style="position: absolute; left: 400px; top: 0px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-400px, 400px, 0px);">
                  ...
                  <div class="gallery-item  filter-3" style="position: absolute; left: 600px; top: 0px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-600px, 600px, 0px);">
                  ...
                  <div class="gallery-item  filter-1" style="position: absolute; left: 800px; top: 0px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-800px, 800px, 0px);">
                  ...
                  <div class="gallery-item  filter-2" style="position: absolute; left: 0px; top: 200px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(0px, 800px, 0px);">
                  ...
                  <div class="gallery-item  filter-3" style="position: absolute; left: 200px; top: 200px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-200px, 1000px, 0px);">
                       <a href="img/photos/08.jpg" data-rel="prettyPhoto[2]" rel="prettyPhoto[2]"> 
                                <img alt="example image" src="img/photos/08.jpg">
                                <div class="bg-cover"></div> 
                        </a> 
                  ...
                  <div class="gallery-item  filter-2" style="position: absolute; left: 400px; top: 200px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-400px, 1200px, 0px);">
                  ...
                  <div class="gallery-item  filter-1" style="position: absolute; left: 600px; top: 200px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-600px, 1400px, 0px);">
                  ...
                  <div class="gallery-item   filter-3" style="position: absolute; left: 800px; top: 200px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-800px, 1600px, 0px);">
                  ...
                  <div class="gallery-item  filter-2" style="position: absolute; left: 0px; top: 400px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(0px, 1600px, 0px);">
                       <a href="img/photos/01.jpg" data-rel="prettyPhoto[2]" rel="prettyPhoto[2]"> 
                                <img alt="example image" src="img/photos/01.jpg">
                                <div class="bg-cover"></div> 
                        </a> 
                  ...
                  <div class="gallery-item  filter-1" style="position: absolute; left: 200px; top: 400px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-200px, 1800px, 0px);">
                   ...
                   <div class="gallery-item  filter-1" style="position: absolute; left: 400px; top: 400px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-400px, 2000px, 0px);">
                   ...
                   <div class="gallery-item  filter-3" style="position: absolute; left: 600px; top: 400px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-600px, 2200px, 0px);">
                   ...
                   <div class="gallery-item  filter-2" style="position: absolute; left: 800px; top: 400px; transition-property: transform, opacity; transition-duration: 0.4s; transform: translate3d(-800px, 2400px, 0px);">
