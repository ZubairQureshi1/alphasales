    ...
    <!-- Page title -->
        <ul class="list-inline menu-left mb-0">
            ...
            <li class="hide-phone list-inline-item app-search">
                <h3 class="page-title">Whatsapp Groups</h3>
            </li>
        </ul>
                        ...
                        <table id="contacts" class="table table-striped table-bordered">
                            ...
                            <tr id="{{$value['id']}}">
                                ...
                                <td>                                                
                                    ...
                                    <button class="btn btn-warning btn-sm" 
                                            data-toggle="modal"
                                            data-target="#view_{{$value['id']}}"
                                            >
                                            <i class="mdi mdi-eye"></i>
                                    </button>
                                </td>
                            </tr>
                            @include('whatsapp.view-group')
                            @include('whatsapp.edit-group')
                            @endforeach
                        </table>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function removeRow(el , group_id , contact_id){
        $("#"+el).remove();
        let token = $("input[name='_token']").val();
        const data = { group_id ,contact_id , _token:token};

        fetch("removeContactFromGroup" , {
          method: 'POST', // or 'PUT'
...
@include('whatsapp.send-message-group')
