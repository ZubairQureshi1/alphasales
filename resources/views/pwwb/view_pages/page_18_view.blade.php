...
@if(isset($data['second_semester_details']['cell_status']) != null )
    <div class="card shadow p-3 w-100">
        <div class="col-md-12">
            <h1>Continue 1(Second Semester)</h1>
            </div><br>
        <div class="card-body ">
            <div class="card shadow p-3 w-100">
                <div class="card-body">
                    <div class="col-md-12 mt-4">
                        <label for="" class="styling">2nd Semester File Received in CFE Cell:</label>
                    </div>
                    <div class="card shadow p-3 w-100">
                        <div class="card-body ">
                            <div class="form-row">
            ...
            <div class="col-md-12 mt-4">
                <label for="" class="styling">File Submitted in PWWB:</label>
            </div>
                        ...
                        @foreach($data['second_semester_result_status_details'] as $secondSemesterResultStatusDetails)
                            ...
                            <div class="form-row mt-2" id="result_status_second_semester_div">
                                ...
                                <div class="col-md-1 p-0">
                                    <label id="checkpassorfail_18" style="margin-left: 40px;">
                                        {{$secondSemesterResultStatusDetails['result'] ? $secondSemesterResultStatusDetails['result'] : ''}}
                                    </label>
                                </div>
                                <div id="fail_18" class="col-md-10 form-row m-0" id="result_status_second_semester_pass_values" style="display: none">
                    ...
                    <div class="card-body ">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label @if( !$data['second_semester_details']['readmissionsecond']) class="text-danger" @endif><strong>Readmission:</strong></label>
                                <label>
                                    {{$data && $data['second_semester_details']['readmissionsecond'] ? $data['second_semester_details']['readmissionsecond'] : '--'}}
                                </label>
                            </div>
                            <div class="form-group col-md-4">
                                <label @if( !$data['second_semester_details']['same_course']) class="text-danger" @endif><strong>Same Course:</strong></label>
                                <label>
                                    {{$data && $data['second_semester_details']['same_course'] ? $data['second_semester_details']['same_course'] : '--'}}
                                </label>
                            </div>
                            <div class="form-group col-md-4">
                                <label @if( !$data['second_semester_details']['changed_course']) class="text-danger" @endif><strong>Changed Course:</strong></label>
                                <label>
                                    {{$data && $data['second_semester_details']['changed_course'] ? $data['second_semester_details']['changed_course'] : '--'}}
                                </label>
                            </div>
                        </div>
                    </div>
...
<script>
    $( document ).ready(function() {
       var checkpassorfail = $('#checkpassorfail_18').text();
