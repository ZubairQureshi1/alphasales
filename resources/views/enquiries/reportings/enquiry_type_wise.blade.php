                    ...
                    <input name="isFilteredRequest" type="hidden" value="true">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div>
                                    <input type="month" name="start_date" id="start_date" data-date-format="MM-DD" value="<?php echo date("m-d"); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label>
                                ...
                                <div>
                                    <input type="month" name="end_date" id="end_date" data-date-format="MM-DD" value="<?php echo date("m-d"); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label>
            ...
            <div class="card-body">
                <div class="padding-10 div-border">
                    <div class="row">
                        ...
                        <div class="col-3 btn-group" role="group">
                            <h6 class="letter-capitalize">Course Wise Enquiry Report</h6>
                        </div> 
                        <div class="col-1">
                        </div> 
                        <div class="col-4"></div>
                ...
                <div class="margin-top-10 padding-10 div-border">
                    <div class="row">
                        ...
                        <div class="col-3 btn-group" role="group">
                            <h6 class="letter-capitalize">Employee Wise Enquiry Report</h6>
                        </div> 
                        <div class="col-1">
                        </div> 
                        <div class="col-4"></div>
