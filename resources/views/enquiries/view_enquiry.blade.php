<form class="target">
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            {!! Form::select('entry_by', App\User::permission('create_enquiries_management')->pluck('name', 'id'), $enquiry->entry_by, ['id' => 'entry_by', 'class' => 'form-control select2 item-required', 'placeholder' => '--- Select Entry By ---', 'errorLabel' => 'Enquiry Entry Type']) !!}
        </div>
                ...
                <div class="margin-10">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input required id="landline" class="form-control" type="text"
                                placeholder="Enter Property Address" name="address"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3" id="followup_date_divedit" hidden="hidden">
                        ...
                        <input class="form-control item-required" errorLabel="Next Followup Date" never-bypass hidden
                            id="next_followup_date_idedit" value={{isset($enquiry->enquiryFollowups[0]->next_date)?$enquiry->enquiryFollowups[0]->next_date:null}} name="next_followup_date" type="date"
