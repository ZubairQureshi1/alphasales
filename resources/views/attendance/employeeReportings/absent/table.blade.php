<div class="table-rep-plugin">
    <div class="table-responsive b-0">
        <table id="attendances_absent_reporting_table" isDefault="true" class="table table-bordered table-striped"  class="tablet" cellspacing="0" width="100%">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Employee Code</th>
            ...
            <tbody id="attendances_absent_reporting_table_body" >
