...
@include('includes/header_end')
        ...
        <ul class="list-inline menu-left mb-0">
            ...
            <li class="hide-phone list-inline-item app-search">
                <h3 class="page-title">Student Lecture Attendance Report</h3>
            </li>
        </ul>
                        ...
                        <div class="margin-10">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 text-center">
                                    <button class="btn btn-success" onclick="onCourseSelect()"> <i class="fa fa-filter" aria-hidden="true"></i> Filter Subjects & Students</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="{{ asset('assets/plugins/parsleyjs/parsley.min.js')  }}"></script>
 ...
 <script src="{{ asset('js/attendance/student_lecture_attendance_view.js') }}"></script>
