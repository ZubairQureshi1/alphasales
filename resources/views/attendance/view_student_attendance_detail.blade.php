                                        ...
                                        <div class="card-body">
                                            <table id="datatable" class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select data_section_id="{{$data->studentAttendance->section_detail_id}}" data_subject_id="{{$data->studentAttendance->section_subject_detail_id}}" data_student_id="{{$data->student->id}}" data_attendance_id="{{$data->id}}" class="form-control" id="status_type" onchange="onStatusChange(event)">
                                                            @foreach(config('constants.attendance_statuses') as $key => $val)                                                            
                                                                <option value="{{$key}}" @if($data->status_id == $key) selected @endif>{{$val}}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td>{{$data->studentAttendance->subject_name ?? '---'}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{url('/studentAttendance/DeleteAttendanceDetails', $data->id)}}"><i class="fa fa-trash btn btn-danger"></i></a>
                                                        </td>
                                                </tr>
                                                @endforeach
                                                </tbody>
