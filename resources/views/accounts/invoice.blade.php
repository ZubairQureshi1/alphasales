                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="invoice-title">
                                                        <h4 class="pull-right font-16"><strong>Voucher Code #{{$installment['voucher_code']}}</strong></h4>
                                                        <h3 class="mt-0">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table" id="invoiceTable">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">{{$installment['amount_per_installment']}}</td>

                                                                        <td class="text-right">{{$installment['amount_per_installment']}}</td>
                                                                    </tr>
