{!! Form::model($fee_package, ['route' => ['accounts.updateFeePackage', $fee_package->id], 'method' => 'post']) !!}
    <table class="table table-bordered">
        <thead class="thead-light">
            <tr>
                <th colspan="2" class="">Student Accounts</th>
            </tr>
        </thead>
        <tbody>
            <tr class="padding-0">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr class="padding-0">
                                ...
                                <td>
                                    <input type="number" onkeypress="return numericOnly(event)" disabled onkeyup="validateNumberByMin(event)" class="form-control text-right admission-has-sum" id="cfe_admission_fee" onchange="" min="0" max="99999" value="{{ $fee_package->cfe_admission_fee }}" name="cfe_admission_fee" placeholder=""/>
                                </td>
                            </tr>
                            <tr class="padding-0">
                                <td>Marketer Incentive</td>
                                <td>
                                    <input type="number" onkeypress="return numericOnly(event)" disabled onkeyup="validateNumberByMin(event)" class="form-control text-right admission-has-sum" id="marketer_incentive" onchange="" min="0" max="99999" value="{{ $fee_package->marketer_incentive }}" name="marketer_incentive" placeholder=""/>
                                </td>
                            </tr>
                            <tr class="padding-0">
                                <td>Registration Fee</td>
                                <td>
                                    <input type="number" onkeypress="return numericOnly(event)" disabled onkeyup="validateNumberByMin(event)" class="form-control text-right admission-has-sum" id="registration_fee" onchange="" min="0" max="9999999" value="{{ $fee_package->registration_fee }}" name="registration_fee" placeholder=""/>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot class="table-footer-light">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="form-control text-right" id="admission_registration_voucher_code" disabled name="admission_registration_voucher_code" value="{{ $fee_package->admission_registration_voucher_code }}" type="text" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)">
                                </td>
                            </tr>
                            <tr>
                                <td>Paid Date</td>
                                <td>
                                    <input class="form-control text-right" data-date-format="YYYY-MM-DD" disabled id="admission_registration_paid_date" value="{{ $fee_package->admission_registration_paid_date }}" name="admission_registration_paid_date" type="date">
                                </td>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr class="padding-0">
                                <td>Tuition Fee</td>
                                <td>
                                    <input class="form-control text-right" id="tuition_fee" disabled name="tuition_fee" disabled="true" value="{{ $fee_package->tuition_fee }}" type="number" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)">
                                </td>
                            </tr>
                            <tr class="padding-0">
                                <td>
                                ...
                                <td>
                                    {!! Form::select('discount_status_id', array_slice(config('constants.discount_statuses'), 21, 23, true), $fee_package->discount_status_id, ['id' => 'discount_status_id', 'class' => 'form-control select2-multiple editable', 'placeholder' => 'Select Scholarship','name' => 'discount_status_id'  , 'disabled'] ) !!}
                                </td>
                            </tr> 
                            <tr class="padding-0">
                                <td>
                                ...
                                <td>
                                    <input class="form-control text-right editable" disabled value="{{ $fee_package->discount }}" id="discount" name="discount" type="number" onkeypress="return numericOnly(event)" min="0" onkeyup="validateNumberByMin(event)" placeholder="Discount (In Rupee)">
                                </td>
                            </tr>  
                            <tr class="padding-0">
                                <td>
                                ...
                                <td>
                                    <div class="input-group">
                                        <input class="form-control text-right editable" disabled value="{{ $fee_package->discount_percentage }}" step=".01" min="0" max="100" id="discount_percentage" name="discount_percentage" type="number" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)" placeholder="Discount (In Percentage)" >
                        ...
                        <tbody> 
                            <tr class="padding-0">
                                <td width="35%">
                                    ...
                                    <input type="number" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)" class="form-control text-right transport-has-multiplies editable" disabled="true" id="transport_month_count" onchange="" min="0" max="99999" value="{{ $fee_package->transport_month_count }}" name="transport_month_count" placeholder="" />
                                </td>
                                <td width="35%">
                                    <label>Amount per Month</label>
                                    <input type="number" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)" class="form-control text-right transport-has-multiplies editable" disabled="true" id="transport_monthly_amount" onchange="" min="0" max="99999" value="{{ $fee_package->transport_monthly_amount }}" name="transport_monthly_amount" placeholder="" />
                                </td>
                            </tr>
                        </tbody>
                        <tfoot class="table-footer-light">
            ...
            <tr>
                ...
                <td>
                    <input type="number" onkeypress="return numericOnly(event)" onkeyup="validateNumberByMin(event)" class="form-control text-right has-sum editable" min="0" max="99999" disabled="true" value="{{ $fee_package->miscellaneous_charges }}" name="miscellaneous_charges" id="miscellaneous_charges" placeholder=""/>
                </td>
            </tr> 
            <tr>
                <td>Others</td>
        ...
        <tfoot class="table-footer-light">
            ...
            <tr>
                <td>Payment Type</td>
                <td>
                    {!! Form::select('fee_structure_type_id', config('constants.fee_structure_types'), $fee_package->fee_structure_type_id, ['id' => 'fee_structure_type_id', 'class' => 'form-control select2-multiple '.($fee_package->fee_structure_type_id == 1 && $fee_package->status_id == 1 ? '' : 'editable') , 'placeholder' => 'Select Type', 'onchange' => 'showHideDueDateOrInstallment()', 'disabled'] ) !!}
                </td>
            </tr>
