             ...
             <!-- Page title -->
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Overall Clearance Slips</h3>
                                </li>
                            </ul>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            {!! Form::open(['id' => 'clearanceslip_form','route' => 'accounts.generateOverallClearanceSlip']) !!}
                                                @csrf
...
@include('includes/footer_start')
    ...
    <script type="text/javascript" src="{{asset('js/accounts/clearanceslip.js')}}"></script>
