                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="invoice-title">
                                                        <h4 class="pull-right font-16"><strong>Voucher Code # {{$headFineStudent['voucher_code']}}</strong></h4>
                                                        <h3 class="mt-0">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6 m-t-30 text-right">
                                                            <address>
                                                                ...
                                                                {{$headFineStudent['due_date']}}<br><br>
                                                            </address>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table" id="invoiceTable">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">{{$headFineStudent->headFine()->get()->first()->amount}}</td>

                                                                        <td class="text-right">{{$headFineStudent->headFine()->get()->first()->amount}}</td>
                                                                    </tr>
