<table cellspacing="0" class="table table-hover table-bordered" id="enquiry_entry_wise_report_table" isdefault="true" width="100%">
    ...
    <tbody class="text-center">
		@foreach($data as $key => $user)
            @php
                $enquiries = App\Models\Enquiry::where('entry_by', $user->id)
