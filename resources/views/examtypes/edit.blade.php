    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-4">
                    <form name="examtype_from" method="post"  action="../{{ $examtypes['id'] }}/update">
                    @csrf
                        <div class="form-group">
                            <label for="exampleInputEmail1">Exam Type:</label>
                                <input type="text" name="exam_type" class="form-control" value="{{ $examtypes->exam_type }}"  placeholder="Enter Exam Type...">
                        </div>
