        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-20">
                    <div class="card-body">
                        @include('sections/section_edit_form')
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    var count_sections = {{ count($section->sectionDetails) }};
    var section_id = {{ $section->id }};
</script>
<script type="text/javascript" src="{{ asset('js/section/section_validator.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/section/section_edit.js') }}"></script>
