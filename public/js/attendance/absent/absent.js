function getPreviousAbsentAttendances() {
	...
	$("#attendances_absent_reporting_table_body").html("");
	$.ajax({
		url: '../getEmployeeAbsentReporting',
		dataType: "json",
		type: "get",
		data: {
		...
		success: function(data) {
			...
			alertify.success("Absent Reporting Retrieved Successfully.");
		},
		error: function(data) {
			console.log(data);
...
function getNextAbsentAttendances() {
...
function showData(attendances) {
	...
	$("#attendances_absent_reporting_table_body").html(add_row);
	document.getElementById('report_loading').hidden = true;
}

function exportAbsentReportingToExcel() {
	var table = TableExport(document.getElementById("attendances_absent_reporting_table"), {
		headers: true, // (Boolean), display table headers (th or td elements) in the <thead>, (default: true)
		footers: false, // (Boolean), display table footers (th or td elements) in the <tfoot>, (default: false)
		formats: ['xlsx'], // (String[]), filetype(s) for the export, (default: ['xlsx', 'csv', 'txt'])
		filename: 'Absentee Reporting', // (id, String), filename for the downloaded file, (default: 'id')
