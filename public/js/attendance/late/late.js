function getPreviousLateAttendances() {
	...
	$("#attendances_late_reporting_table_body").html("");
	$.ajax({
		url: '../getEmployeeLateReporting',
		dataType: "json",
		type: "get",
		data: {
		...
		success: function(data) {
			...
			alertify.success("Late Reporting Retrieved Successfully.");
		},
		error: function(data) {
			console.log(data);
...
function getNextLateAttendances() {
...
function showData(attendances) {
	...
	$("#attendances_late_reporting_table_body").html(add_row);
	document.getElementById('report_loading').hidden = true;
}

function exportLateReportingToExcel() {
	var table = TableExport(document.getElementById("attendances_late_reporting_table"), {
