...
function exportReportingToExcel(module_name) {
    ...
    var table = TableExport(document.getElementById(module_name), {
        ...
        filename: 'Overall Visitor Attendnace Report', // (id, String), filename for the downloaded file, (default: 'id')
...
function getFilterData(route) {
    ...
    if (document.getElementById('visitor_user_id') != null && document.getElementById('visitor_user_id').value != '') {
        querry_string += 'user_id:' + document.getElementById('visitor_user_id').value + ';';
    }
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.data.user.length == 1) {
                document.getElementById('emp_attendance_export').href = '../visitorEmployeeAttendances/exportExcel/' + data.data.user[0].id;
            ...
            if (data.data.user.length == 1) {
                ...
                exportReportingToExcel("overall_attendances_reporting_body" /*data.data.module_name*/ );
            }
