...
class AddForeignKeysToEmploymentsTable extends Migration {
	...
	public function down()
	{
		Schema::table('employments', function(Blueprint $table)
		{
			$table->dropForeign('employments_academic_wing_id_foreign');
			$table->dropForeign('employments_organization_campus_id_foreign');
			$table->dropForeign('employments_organization_id_foreign');
		});
	}
