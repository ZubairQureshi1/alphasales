...
class AddForeignKeysToAcademicRecordsTable extends Migration {
	...
	public function down()
	{
		Schema::table('academic_records', function(Blueprint $table)
		{
			$table->dropForeign('academic_records_academic_wing_id_foreign');
			$table->dropForeign('academic_records_organization_campus_id_foreign');
			$table->dropForeign('academic_records_organization_id_foreign');
		});
	}
