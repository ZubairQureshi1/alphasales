...
class AddForeignKeysToSixthSemesterResultStatusDetailsTable extends Migration {
	...
	public function down()
	{
		Schema::table('sixth_semester_result_status_details', function(Blueprint $table)
		{
			$table->dropForeign('sixth_semester_result_status_details_index_table_id_foreign');
		});
	}
