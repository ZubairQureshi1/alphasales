...
class AddForeignKeysToAdmissionByEnquiryFormsTable extends Migration {
	...
	public function down()
	{
		Schema::table('admission_by_enquiry_forms', function(Blueprint $table)
		{
			$table->dropForeign('admission_by_enquiry_forms_academic_wing_id_foreign');
			$table->dropForeign('admission_by_enquiry_forms_organization_campus_id_foreign');
			$table->dropForeign('admission_by_enquiry_forms_organization_id_foreign');
		});
	}
