...
class CreateFourthSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('fourth_semester_details', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->bigInteger('index_table_id')->unsigned()->index('fourth_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissionfourth', 191)->nullable();
	...
	{
		Schema::drop('fourth_semester_details');
	}
