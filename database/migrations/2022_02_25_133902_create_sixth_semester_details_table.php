...
class CreateSixthSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('sixth_semester_details', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->bigInteger('index_table_id')->unsigned()->index('sixth_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissionsix', 191)->nullable();
	...
	{
		Schema::drop('sixth_semester_details');
	}
