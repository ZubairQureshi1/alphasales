...
class CreateSecondSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('second_semester_details', function(Blueprint $table)
		{
			...
			$table->bigInteger('index_table_id')->unsigned()->index('second_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissionsecond', 191)->nullable();
	...
	{
		Schema::drop('second_semester_details');
	}
