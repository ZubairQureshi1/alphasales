...
class AddForeignKeysToTimePeriodsTable extends Migration {
	...
	public function down()
	{
		Schema::table('time_periods', function(Blueprint $table)
		{
			$table->dropForeign('time_periods_academic_wing_id_foreign');
			$table->dropForeign('time_periods_organization_campus_id_foreign');
			$table->dropForeign('time_periods_organization_id_foreign');
		});
	}
