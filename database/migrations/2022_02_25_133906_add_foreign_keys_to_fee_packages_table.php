...
class AddForeignKeysToFeePackagesTable extends Migration {
	...
	public function down()
	{
		Schema::table('fee_packages', function(Blueprint $table)
		{
			$table->dropForeign('fee_packages_academic_wing_id_foreign');
			$table->dropForeign('fee_packages_organization_campus_id_foreign');
			$table->dropForeign('fee_packages_organization_id_foreign');
		});
	}
