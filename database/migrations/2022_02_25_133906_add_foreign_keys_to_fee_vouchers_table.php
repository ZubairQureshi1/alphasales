...
class AddForeignKeysToFeeVouchersTable extends Migration {
	...
	public function down()
	{
		Schema::table('fee_vouchers', function(Blueprint $table)
		{
			$table->dropForeign('fee_vouchers_academic_wing_id_foreign');
			$table->dropForeign('fee_vouchers_organization_campus_id_foreign');
			$table->dropForeign('fee_vouchers_organization_id_foreign');
		});
	}
