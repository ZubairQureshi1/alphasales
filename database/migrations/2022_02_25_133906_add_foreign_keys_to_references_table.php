...
class AddForeignKeysToReferencesTable extends Migration {
	...
	public function down()
	{
		Schema::table('references', function(Blueprint $table)
		{
			$table->dropForeign('references_academic_wing_id_foreign');
			$table->dropForeign('references_organization_campus_id_foreign');
			$table->dropForeign('references_organization_id_foreign');
		});
	}
