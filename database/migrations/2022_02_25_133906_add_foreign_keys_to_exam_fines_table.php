...
class AddForeignKeysToExamFinesTable extends Migration {
	...
	public function down()
	{
		Schema::table('exam_fines', function(Blueprint $table)
		{
			$table->dropForeign('exam_fines_academic_wing_id_foreign');
			$table->dropForeign('exam_fines_organization_campus_id_foreign');
			$table->dropForeign('exam_fines_organization_id_foreign');
		});
	}
