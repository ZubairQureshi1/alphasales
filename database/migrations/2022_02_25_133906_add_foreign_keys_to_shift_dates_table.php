...
class AddForeignKeysToShiftDatesTable extends Migration {
	...
	public function down()
	{
		Schema::table('shift_dates', function(Blueprint $table)
		{
			$table->dropForeign('shift_dates_academic_wing_id_foreign');
			$table->dropForeign('shift_dates_organization_campus_id_foreign');
			$table->dropForeign('shift_dates_organization_id_foreign');
		});
	}
