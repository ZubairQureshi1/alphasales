...
class AddForeignKeysToDateSheetRoomsTable extends Migration {
	...
	public function up()
	{
		Schema::table('date_sheet_rooms', function(Blueprint $table)
		{
	...
	public function down()
	{
		Schema::table('date_sheet_rooms', function(Blueprint $table)
		{
			$table->dropForeign('date_sheet_rooms_academic_wing_id_foreign');
			$table->dropForeign('date_sheet_rooms_organization_campus_id_foreign');
			$table->dropForeign('date_sheet_rooms_organization_id_foreign');
		});
	}
