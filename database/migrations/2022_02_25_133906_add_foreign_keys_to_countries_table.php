...
class AddForeignKeysToCountriesTable extends Migration {
	...
	public function down()
	{
		Schema::table('countries', function(Blueprint $table)
		{
			$table->dropForeign('countries_academic_wing_id_foreign');
			$table->dropForeign('countries_organization_campus_id_foreign');
			$table->dropForeign('countries_organization_id_foreign');
		});
	}
