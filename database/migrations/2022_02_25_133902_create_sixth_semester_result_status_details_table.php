...
class CreateSixthSemesterResultStatusDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('sixth_semester_result_status_details', function(Blueprint $table)
		{
			...
			$table->bigInteger('index_table_id')->unsigned()->index('sixth_semester_result_status_details_index_table_id_foreign');
	...
	{
		Schema::drop('sixth_semester_result_status_details');
	}
