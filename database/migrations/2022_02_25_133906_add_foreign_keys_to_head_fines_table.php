...
class AddForeignKeysToHeadFinesTable extends Migration {
	...
	public function up()
	{
		Schema::table('head_fines', function(Blueprint $table)
		{
	...
	public function down()
	{
		Schema::table('head_fines', function(Blueprint $table)
		{
			$table->dropForeign('head_fines_academic_wing_id_foreign');
			$table->dropForeign('head_fines_organization_campus_id_foreign');
			$table->dropForeign('head_fines_organization_id_foreign');
		});
	}
