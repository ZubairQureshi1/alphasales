...
class AddForeignKeysToEnquiryWorkersTable extends Migration {
	...
	public function down()
	{
		Schema::table('enquiry_workers', function(Blueprint $table)
		{
			$table->dropForeign('enquiry_workers_academic_wing_id_foreign');
			$table->dropForeign('enquiry_workers_organization_campus_id_foreign');
			$table->dropForeign('enquiry_workers_organization_id_foreign');
		});
	}
