...
class AddForeignKeysToAttendanceFinesTable extends Migration {
	...
	public function down()
	{
		Schema::table('attendance_fines', function(Blueprint $table)
		{
			$table->dropForeign('attendance_fines_academic_wing_id_foreign');
			$table->dropForeign('attendance_fines_organization_campus_id_foreign');
			$table->dropForeign('attendance_fines_organization_id_foreign');
		});
	}
