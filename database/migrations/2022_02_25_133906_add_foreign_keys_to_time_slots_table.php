...
class AddForeignKeysToTimeSlotsTable extends Migration {
	...
	public function down()
	{
		Schema::table('time_slots', function(Blueprint $table)
		{
			$table->dropForeign('time_slots_academic_wing_id_foreign');
			$table->dropForeign('time_slots_organization_campus_id_foreign');
			$table->dropForeign('time_slots_organization_id_foreign');
		});
	}
