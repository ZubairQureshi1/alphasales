...
class AddForeignKeysToShiftWorkingDaysTable extends Migration {
	...
	public function down()
	{
		Schema::table('shift_working_days', function(Blueprint $table)
		{
			$table->dropForeign('shift_working_days_academic_wing_id_foreign');
			$table->dropForeign('shift_working_days_organization_campus_id_foreign');
			$table->dropForeign('shift_working_days_organization_id_foreign');
		});
	}
