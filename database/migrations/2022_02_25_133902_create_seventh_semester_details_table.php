...
class CreateSeventhSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('seventh_semester_details', function(Blueprint $table)
		{
			...
			$table->bigInteger('index_table_id')->unsigned()->index('seventh_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissionseven', 191)->nullable();
	...
	{
		Schema::drop('seventh_semester_details');
	}
