...
class CreateEighthSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('eighth_semester_details', function(Blueprint $table)
		{
			...
			$table->bigInteger('index_table_id')->unsigned()->index('eighth_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissioneight', 191)->nullable();
	...
	{
		Schema::drop('eighth_semester_details');
	}
