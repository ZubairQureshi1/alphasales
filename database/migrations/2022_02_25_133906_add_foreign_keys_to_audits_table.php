...
class AddForeignKeysToAuditsTable extends Migration {
	...
	public function down()
	{
		Schema::table('audits', function(Blueprint $table)
		{
			$table->dropForeign('audits_academic_wing_id_foreign');
			$table->dropForeign('audits_organization_campus_id_foreign');
			$table->dropForeign('audits_organization_id_foreign');
		});
	}
