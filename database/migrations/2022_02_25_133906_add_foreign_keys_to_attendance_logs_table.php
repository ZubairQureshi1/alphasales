...
class AddForeignKeysToAttendanceLogsTable extends Migration {
	...
	public function down()
	{
		Schema::table('attendance_logs', function(Blueprint $table)
		{
			$table->dropForeign('attendance_logs_academic_wing_id_foreign');
			$table->dropForeign('attendance_logs_organization_campus_id_foreign');
			$table->dropForeign('attendance_logs_organization_id_foreign');
		});
	}
