...
class CreateSecondSemesterResultStatusDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('second_semester_result_status_details', function(Blueprint $table)
		{
			...
			$table->bigInteger('index_table_id')->unsigned()->index('second_semester_result_status_details_index_table_id_foreign');
	...
	{
		Schema::drop('second_semester_result_status_details');
	}
