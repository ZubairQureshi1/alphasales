...
class AddForeignKeysToSystemRollNumbersTable extends Migration {
	...
	public function down()
	{
		Schema::table('system_roll_numbers', function(Blueprint $table)
		{
			$table->dropForeign('system_roll_numbers_academic_wing_id_foreign');
			$table->dropForeign('system_roll_numbers_organization_campus_id_foreign');
			$table->dropForeign('system_roll_numbers_organization_id_foreign');
		});
	}
