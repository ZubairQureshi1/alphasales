...
class AddForeignKeysToDateSheetBooksTable extends Migration {
	...
	public function down()
	{
		Schema::table('date_sheet_books', function(Blueprint $table)
		{
			$table->dropForeign('date_sheet_books_academic_wing_id_foreign');
			$table->dropForeign('date_sheet_books_organization_campus_id_foreign');
			$table->dropForeign('date_sheet_books_organization_id_foreign');
		});
	}
