...
class CreateThirdSemesterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('third_semester_details', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->bigInteger('index_table_id')->unsigned()->index('third_semester_details_index_table_id_foreign');
			...
			$table->timestamps(3);
			$table->string('readmissionthird', 191)->nullable();
	...
	{
		Schema::drop('third_semester_details');
	}
