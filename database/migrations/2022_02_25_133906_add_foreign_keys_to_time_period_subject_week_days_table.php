...
class AddForeignKeysToTimePeriodSubjectWeekDaysTable extends Migration {
	...
	public function down()
	{
		Schema::table('time_period_subject_week_days', function(Blueprint $table)
		{
			$table->dropForeign('time_period_subject_week_days_academic_wing_id_foreign');
			$table->dropForeign('time_period_subject_week_days_organization_campus_id_foreign');
			$table->dropForeign('time_period_subject_week_days_organization_id_foreign');
		});
	}
