...
class AddForeignKeysToModelHasPermissionsTable extends Migration {
	...
	public function down()
	{
		Schema::table('model_has_permissions', function(Blueprint $table)
		{
			$table->dropForeign('model_has_permissions_academic_wing_id_foreign');
			$table->dropForeign('model_has_permissions_organization_campus_id_foreign');
			$table->dropForeign('model_has_permissions_organization_id_foreign');
		});
	}
