...
class AddForeignKeysToFeeFineVouchersTable extends Migration {
	...
	public function down()
	{
		Schema::table('fee_fine_vouchers', function(Blueprint $table)
		{
			$table->dropForeign('fee_fine_vouchers_academic_wing_id_foreign');
			$table->dropForeign('fee_fine_vouchers_organization_campus_id_foreign');
			$table->dropForeign('fee_fine_vouchers_organization_id_foreign');
		});
	}
