...
class AddForeignKeysToDateSheetStudentsTable extends Migration {
	...
	public function down()
	{
		Schema::table('date_sheet_students', function(Blueprint $table)
		{
			$table->dropForeign('date_sheet_students_academic_wing_id_foreign');
			$table->dropForeign('date_sheet_students_organization_campus_id_foreign');
			$table->dropForeign('date_sheet_students_organization_id_foreign');
		});
	}
