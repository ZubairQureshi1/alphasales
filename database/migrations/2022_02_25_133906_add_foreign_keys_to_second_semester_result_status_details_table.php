...
class AddForeignKeysToSecondSemesterResultStatusDetailsTable extends Migration {
	...
	public function down()
	{
		Schema::table('second_semester_result_status_details', function(Blueprint $table)
		{
			$table->dropForeign('second_semester_result_status_details_index_table_id_foreign');
		});
	}
